...
enum ClipType { pointed, curved, arc, beziarArc, traingle, waved }

class ShapeCustom extends StatelessWidget {
  Widget child;
  ClipType clipType;

  ShapeCustom({this.child, this.clipType = ClipType.curved});
...
class ZigZagClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    if (clipType == ClipType.pointed)
      ...
      createArc(size, path);
    else if (clipType == ClipType.beziarArc)
